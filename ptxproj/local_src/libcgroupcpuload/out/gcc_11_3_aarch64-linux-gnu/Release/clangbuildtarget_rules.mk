...
$(DEPS_libcgroupcpuload.so) $(OBJS_libcgroupcpuload.so) $(LOBS_libcgroupcpuload.so) $(TIDYS_libcgroupcpuload.so) $(PLINTS_libcgroupcpuload.so) ./out/gcc_11_3_aarch64-linux-gnu/Release/libcgroupcpuload.so/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libcgroupcpuload.so_CPPFLAGS)

$(DEPS_libcgroupcpuload.so) $(OBJS_libcgroupcpuload.so) $(TIDYS_libcgroupcpuload.so) $(PLINTS_libcgroupcpuload.so) ./out/gcc_11_3_aarch64-linux-gnu/Release/libcgroupcpuload.so/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libcgroupcpuload.so_CXXFLAGS)

$(DEPS_libcgroupcpuload.so) $(OBJS_libcgroupcpuload.so) $(TIDYS_libcgroupcpuload.so) $(PLINTS_libcgroupcpuload.so) ./out/gcc_11_3_aarch64-linux-gnu/Release/libcgroupcpuload.so/lint_mac.h: BUILDTARGET_CFLAGS:=$(libcgroupcpuload.so_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/libcgroupcpuload.so-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libcgroupcpuload.so,$<) > $@
...
$(OUT_DIR)/libcgroupcpuload.so/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libcgroupcpuload.so_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/libcgroupcpuload.so/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libcgroupcpuload.so/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libcgroupcpuload.so_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/libcgroupcpuload.so/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_loadcompare.elf) $(OBJS_loadcompare.elf) $(LOBS_loadcompare.elf) $(TIDYS_loadcompare.elf) $(PLINTS_loadcompare.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/loadcompare.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(loadcompare.elf_CPPFLAGS)

$(DEPS_loadcompare.elf) $(OBJS_loadcompare.elf) $(TIDYS_loadcompare.elf) $(PLINTS_loadcompare.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/loadcompare.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(loadcompare.elf_CXXFLAGS)

$(DEPS_loadcompare.elf) $(OBJS_loadcompare.elf) $(TIDYS_loadcompare.elf) $(PLINTS_loadcompare.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/loadcompare.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(loadcompare.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/loadcompare.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,loadcompare.elf,$<) > $@
...
$(OUT_DIR)/loadcompare.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(loadcompare.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/loadcompare.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/loadcompare.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(loadcompare.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/loadcompare.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_checkcpu.elf) $(OBJS_checkcpu.elf) $(LOBS_checkcpu.elf) $(TIDYS_checkcpu.elf) $(PLINTS_checkcpu.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/checkcpu.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(checkcpu.elf_CPPFLAGS)

$(DEPS_checkcpu.elf) $(OBJS_checkcpu.elf) $(TIDYS_checkcpu.elf) $(PLINTS_checkcpu.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/checkcpu.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(checkcpu.elf_CXXFLAGS)

$(DEPS_checkcpu.elf) $(OBJS_checkcpu.elf) $(TIDYS_checkcpu.elf) $(PLINTS_checkcpu.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/checkcpu.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(checkcpu.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/checkcpu.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,checkcpu.elf,$<) > $@
...
$(OUT_DIR)/checkcpu.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(checkcpu.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/checkcpu.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/checkcpu.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(checkcpu.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/checkcpu.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_cpuload.elf) $(OBJS_cpuload.elf) $(LOBS_cpuload.elf) $(TIDYS_cpuload.elf) $(PLINTS_cpuload.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuload.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(cpuload.elf_CPPFLAGS)

$(DEPS_cpuload.elf) $(OBJS_cpuload.elf) $(TIDYS_cpuload.elf) $(PLINTS_cpuload.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuload.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(cpuload.elf_CXXFLAGS)

$(DEPS_cpuload.elf) $(OBJS_cpuload.elf) $(TIDYS_cpuload.elf) $(PLINTS_cpuload.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuload.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(cpuload.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/cpuload.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,cpuload.elf,$<) > $@
...
$(OUT_DIR)/cpuload.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(cpuload.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuload.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/cpuload.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(cpuload.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuload.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_bellysmile.elf) $(OBJS_bellysmile.elf) $(LOBS_bellysmile.elf) $(TIDYS_bellysmile.elf) $(PLINTS_bellysmile.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/bellysmile.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(bellysmile.elf_CPPFLAGS)

$(DEPS_bellysmile.elf) $(OBJS_bellysmile.elf) $(TIDYS_bellysmile.elf) $(PLINTS_bellysmile.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/bellysmile.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(bellysmile.elf_CXXFLAGS)

$(DEPS_bellysmile.elf) $(OBJS_bellysmile.elf) $(TIDYS_bellysmile.elf) $(PLINTS_bellysmile.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/bellysmile.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(bellysmile.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/bellysmile.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,bellysmile.elf,$<) > $@
...
$(OUT_DIR)/bellysmile.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(bellysmile.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/bellysmile.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/bellysmile.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(bellysmile.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/bellysmile.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_testapp.elf) $(OBJS_testapp.elf) $(LOBS_testapp.elf) $(TIDYS_testapp.elf) $(PLINTS_testapp.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/testapp.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(testapp.elf_CPPFLAGS)

$(DEPS_testapp.elf) $(OBJS_testapp.elf) $(TIDYS_testapp.elf) $(PLINTS_testapp.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/testapp.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(testapp.elf_CXXFLAGS)

$(DEPS_testapp.elf) $(OBJS_testapp.elf) $(TIDYS_testapp.elf) $(PLINTS_testapp.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/testapp.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(testapp.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/testapp.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,testapp.elf,$<) > $@
...
$(OUT_DIR)/testapp.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(testapp.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/testapp.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/testapp.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(testapp.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/testapp.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_cpuloadmonitor.elf) $(OBJS_cpuloadmonitor.elf) $(LOBS_cpuloadmonitor.elf) $(TIDYS_cpuloadmonitor.elf) $(PLINTS_cpuloadmonitor.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuloadmonitor.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(cpuloadmonitor.elf_CPPFLAGS)

$(DEPS_cpuloadmonitor.elf) $(OBJS_cpuloadmonitor.elf) $(TIDYS_cpuloadmonitor.elf) $(PLINTS_cpuloadmonitor.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuloadmonitor.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(cpuloadmonitor.elf_CXXFLAGS)

$(DEPS_cpuloadmonitor.elf) $(OBJS_cpuloadmonitor.elf) $(TIDYS_cpuloadmonitor.elf) $(PLINTS_cpuloadmonitor.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuloadmonitor.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(cpuloadmonitor.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/cpuloadmonitor.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,cpuloadmonitor.elf,$<) > $@
...
$(OUT_DIR)/cpuloadmonitor.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(cpuloadmonitor.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuloadmonitor.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/cpuloadmonitor.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(cpuloadmonitor.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/cpuloadmonitor.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_alltests_test.elf) $(OBJS_alltests_test.elf) $(LOBS_alltests_test.elf) $(TIDYS_alltests_test.elf) $(PLINTS_alltests_test.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/alltests_test.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(alltests_test.elf_CPPFLAGS)

$(DEPS_alltests_test.elf) $(OBJS_alltests_test.elf) $(TIDYS_alltests_test.elf) $(PLINTS_alltests_test.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/alltests_test.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(alltests_test.elf_CXXFLAGS)

$(DEPS_alltests_test.elf) $(OBJS_alltests_test.elf) $(TIDYS_alltests_test.elf) $(PLINTS_alltests_test.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/alltests_test.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(alltests_test.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/alltests_test.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,alltests_test.elf,$<) > $@
...
$(OUT_DIR)/alltests_test.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(alltests_test.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/alltests_test.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/alltests_test.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(alltests_test.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/alltests_test.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
