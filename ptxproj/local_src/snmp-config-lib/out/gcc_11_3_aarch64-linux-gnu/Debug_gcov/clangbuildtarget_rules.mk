...
$(DEPS_libsnmpconfig.a) $(OBJS_libsnmpconfig.a) $(LOBS_libsnmpconfig.a) $(TIDYS_libsnmpconfig.a) $(PLINTS_libsnmpconfig.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.a/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libsnmpconfig.a_CPPFLAGS)

$(DEPS_libsnmpconfig.a) $(OBJS_libsnmpconfig.a) $(TIDYS_libsnmpconfig.a) $(PLINTS_libsnmpconfig.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.a/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libsnmpconfig.a_CXXFLAGS)

$(DEPS_libsnmpconfig.a) $(OBJS_libsnmpconfig.a) $(TIDYS_libsnmpconfig.a) $(PLINTS_libsnmpconfig.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.a/lint_mac.h: BUILDTARGET_CFLAGS:=$(libsnmpconfig.a_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/info/libsnmpconfig.a-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libsnmpconfig.a,$<) > $@
...
$(OUT_DIR)/libsnmpconfig.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libsnmpconfig.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.a/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libsnmpconfig.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libsnmpconfig.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_libsnmpconfig.so) $(OBJS_libsnmpconfig.so) $(LOBS_libsnmpconfig.so) $(TIDYS_libsnmpconfig.so) $(PLINTS_libsnmpconfig.so) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.so/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libsnmpconfig.so_CPPFLAGS)

$(DEPS_libsnmpconfig.so) $(OBJS_libsnmpconfig.so) $(TIDYS_libsnmpconfig.so) $(PLINTS_libsnmpconfig.so) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.so/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libsnmpconfig.so_CXXFLAGS)

$(DEPS_libsnmpconfig.so) $(OBJS_libsnmpconfig.so) $(TIDYS_libsnmpconfig.so) $(PLINTS_libsnmpconfig.so) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.so/lint_mac.h: BUILDTARGET_CFLAGS:=$(libsnmpconfig.so_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/info/libsnmpconfig.so-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libsnmpconfig.so,$<) > $@
...
$(OUT_DIR)/libsnmpconfig.so/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libsnmpconfig.so_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.so/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libsnmpconfig.so/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libsnmpconfig.so_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug_gcov/libsnmpconfig.so/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
