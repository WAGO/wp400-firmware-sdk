...
$(DEPS_libconfigstp.a) $(OBJS_libconfigstp.a) $(LOBS_libconfigstp.a) $(TIDYS_libconfigstp.a) $(PLINTS_libconfigstp.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.a/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libconfigstp.a_CPPFLAGS)

$(DEPS_libconfigstp.a) $(OBJS_libconfigstp.a) $(TIDYS_libconfigstp.a) $(PLINTS_libconfigstp.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.a/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libconfigstp.a_CXXFLAGS)

$(DEPS_libconfigstp.a) $(OBJS_libconfigstp.a) $(TIDYS_libconfigstp.a) $(PLINTS_libconfigstp.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.a/lint_mac.h: BUILDTARGET_CFLAGS:=$(libconfigstp.a_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug/info/libconfigstp.a-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libconfigstp.a,$<) > $@
...
$(OUT_DIR)/libconfigstp.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libconfigstp.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.a/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libconfigstp.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libconfigstp.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_libconfigstp.so) $(OBJS_libconfigstp.so) $(LOBS_libconfigstp.so) $(TIDYS_libconfigstp.so) $(PLINTS_libconfigstp.so) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.so/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libconfigstp.so_CPPFLAGS)

$(DEPS_libconfigstp.so) $(OBJS_libconfigstp.so) $(TIDYS_libconfigstp.so) $(PLINTS_libconfigstp.so) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.so/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libconfigstp.so_CXXFLAGS)

$(DEPS_libconfigstp.so) $(OBJS_libconfigstp.so) $(TIDYS_libconfigstp.so) $(PLINTS_libconfigstp.so) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.so/lint_mac.h: BUILDTARGET_CFLAGS:=$(libconfigstp.so_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug/info/libconfigstp.so-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libconfigstp.so,$<) > $@
...
$(OUT_DIR)/libconfigstp.so/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libconfigstp.so_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.so/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libconfigstp.so/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libconfigstp.so_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libconfigstp.so/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
