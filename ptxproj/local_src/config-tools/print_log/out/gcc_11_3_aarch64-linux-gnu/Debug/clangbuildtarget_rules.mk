...
$(DEPS_print_log.elf) $(OBJS_print_log.elf) $(LOBS_print_log.elf) $(TIDYS_print_log.elf) $(PLINTS_print_log.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/print_log.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(print_log.elf_CPPFLAGS)

$(DEPS_print_log.elf) $(OBJS_print_log.elf) $(TIDYS_print_log.elf) $(PLINTS_print_log.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/print_log.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(print_log.elf_CXXFLAGS)

$(DEPS_print_log.elf) $(OBJS_print_log.elf) $(TIDYS_print_log.elf) $(PLINTS_print_log.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/print_log.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(print_log.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug/info/print_log.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,print_log.elf,$<) > $@
...
$(OUT_DIR)/print_log.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(print_log.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/print_log.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/print_log.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(print_log.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/print_log.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_libutil_log.a) $(OBJS_libutil_log.a) $(LOBS_libutil_log.a) $(TIDYS_libutil_log.a) $(PLINTS_libutil_log.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libutil_log.a/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libutil_log.a_CPPFLAGS)

$(DEPS_libutil_log.a) $(OBJS_libutil_log.a) $(TIDYS_libutil_log.a) $(PLINTS_libutil_log.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libutil_log.a/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libutil_log.a_CXXFLAGS)

$(DEPS_libutil_log.a) $(OBJS_libutil_log.a) $(TIDYS_libutil_log.a) $(PLINTS_libutil_log.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libutil_log.a/lint_mac.h: BUILDTARGET_CFLAGS:=$(libutil_log.a_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug/info/libutil_log.a-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libutil_log.a,$<) > $@
...
$(OUT_DIR)/libutil_log.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libutil_log.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libutil_log.a/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libutil_log.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libutil_log.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libutil_log.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
