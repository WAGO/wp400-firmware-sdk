...
$(DEPS_config_snmp.elf) $(OBJS_config_snmp.elf) $(LOBS_config_snmp.elf) $(TIDYS_config_snmp.elf) $(PLINTS_config_snmp.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/config_snmp.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(config_snmp.elf_CPPFLAGS)

$(DEPS_config_snmp.elf) $(OBJS_config_snmp.elf) $(TIDYS_config_snmp.elf) $(PLINTS_config_snmp.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/config_snmp.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(config_snmp.elf_CXXFLAGS)

$(DEPS_config_snmp.elf) $(OBJS_config_snmp.elf) $(TIDYS_config_snmp.elf) $(PLINTS_config_snmp.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/config_snmp.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(config_snmp.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug/info/config_snmp.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,config_snmp.elf,$<) > $@
...
$(OUT_DIR)/config_snmp.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(config_snmp.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/config_snmp.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/config_snmp.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(config_snmp.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/config_snmp.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_libsnmp-config.a) $(OBJS_libsnmp-config.a) $(LOBS_libsnmp-config.a) $(TIDYS_libsnmp-config.a) $(PLINTS_libsnmp-config.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libsnmp-config.a/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libsnmp-config.a_CPPFLAGS)

$(DEPS_libsnmp-config.a) $(OBJS_libsnmp-config.a) $(TIDYS_libsnmp-config.a) $(PLINTS_libsnmp-config.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libsnmp-config.a/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libsnmp-config.a_CXXFLAGS)

$(DEPS_libsnmp-config.a) $(OBJS_libsnmp-config.a) $(TIDYS_libsnmp-config.a) $(PLINTS_libsnmp-config.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libsnmp-config.a/lint_mac.h: BUILDTARGET_CFLAGS:=$(libsnmp-config.a_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug/info/libsnmp-config.a-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libsnmp-config.a,$<) > $@
...
$(OUT_DIR)/libsnmp-config.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libsnmp-config.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libsnmp-config.a/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libsnmp-config.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libsnmp-config.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libsnmp-config.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
