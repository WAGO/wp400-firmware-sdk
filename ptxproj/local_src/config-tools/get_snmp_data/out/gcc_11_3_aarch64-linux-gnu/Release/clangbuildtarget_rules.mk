...
$(DEPS_get_snmp_data.elf) $(OBJS_get_snmp_data.elf) $(LOBS_get_snmp_data.elf) $(TIDYS_get_snmp_data.elf) $(PLINTS_get_snmp_data.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/get_snmp_data.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(get_snmp_data.elf_CPPFLAGS)

$(DEPS_get_snmp_data.elf) $(OBJS_get_snmp_data.elf) $(TIDYS_get_snmp_data.elf) $(PLINTS_get_snmp_data.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/get_snmp_data.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(get_snmp_data.elf_CXXFLAGS)

$(DEPS_get_snmp_data.elf) $(OBJS_get_snmp_data.elf) $(TIDYS_get_snmp_data.elf) $(PLINTS_get_snmp_data.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/get_snmp_data.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(get_snmp_data.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/get_snmp_data.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,get_snmp_data.elf,$<) > $@
...
$(OUT_DIR)/get_snmp_data.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(get_snmp_data.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/get_snmp_data.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/get_snmp_data.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(get_snmp_data.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/get_snmp_data.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_libget_snmp_data.a) $(OBJS_libget_snmp_data.a) $(LOBS_libget_snmp_data.a) $(TIDYS_libget_snmp_data.a) $(PLINTS_libget_snmp_data.a) ./out/gcc_11_3_aarch64-linux-gnu/Release/libget_snmp_data.a/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libget_snmp_data.a_CPPFLAGS)

$(DEPS_libget_snmp_data.a) $(OBJS_libget_snmp_data.a) $(TIDYS_libget_snmp_data.a) $(PLINTS_libget_snmp_data.a) ./out/gcc_11_3_aarch64-linux-gnu/Release/libget_snmp_data.a/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libget_snmp_data.a_CXXFLAGS)

$(DEPS_libget_snmp_data.a) $(OBJS_libget_snmp_data.a) $(TIDYS_libget_snmp_data.a) $(PLINTS_libget_snmp_data.a) ./out/gcc_11_3_aarch64-linux-gnu/Release/libget_snmp_data.a/lint_mac.h: BUILDTARGET_CFLAGS:=$(libget_snmp_data.a_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/libget_snmp_data.a-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libget_snmp_data.a,$<) > $@
...
$(OUT_DIR)/libget_snmp_data.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libget_snmp_data.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/libget_snmp_data.a/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libget_snmp_data.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libget_snmp_data.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/libget_snmp_data.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
