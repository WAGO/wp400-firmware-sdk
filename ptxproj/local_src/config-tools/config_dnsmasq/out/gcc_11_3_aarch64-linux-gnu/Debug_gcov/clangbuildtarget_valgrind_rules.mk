...
nulgrind-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL = $(VALGRIND_FLAGS)        $(config_dnsmasq_c.elf_VALGRIND_FLAGS)        $(NULGRIND_FLAGS)        $(config_dnsmasq_c.elf_NULGRIND_FLAGS) $(call valgrind_xml_flags,config_dnsmasq_c.elf,NULGRIND)
nulgrind-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL = $(VALGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_VALGRIND_TARGET_FLAGS) $(NULGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_NULGRIND_TARGET_FLAGS) $(VALGRIND_GTEST_FILTER_FLAGS)
nulgrind-target-config_dnsmasq_c.elf: VALGRIND_GTEST_FILTER?=*:-*_Target*.*:*.*_Target*
nulgrind-target-config_dnsmasq_c.elf: VALGRIND_TARGET_EXECUTABLE=config_dnsmasq_c.elf
nulgrind-target-config_dnsmasq_c.elf: VG_TOOL=nulgrind
nulgrind-target-config_dnsmasq_c.elf: $(BIN_DIR)/config_dnsmasq_c.elf $(VALGRIND)
nulgrind-target-config_dnsmasq_c.elf: VALGRIND_ARGS=$(VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL) $(VG_ABS_DUT) $(VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL)
nulgrind-target-config_dnsmasq_c.elf:
	$(call vg-version)
	$(call vg-caller)
...
memcheck-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL = $(VALGRIND_FLAGS)        $(config_dnsmasq_c.elf_VALGRIND_FLAGS)        $(MEMCHECK_FLAGS)        $(config_dnsmasq_c.elf_MEMCHECK_FLAGS) $(call valgrind_xml_flags,config_dnsmasq_c.elf,MEMCHECK)
memcheck-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL = $(VALGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_VALGRIND_TARGET_FLAGS) $(MEMCHECK_TARGET_FLAGS) $(config_dnsmasq_c.elf_MEMCHECK_TARGET_FLAGS) $(VALGRIND_GTEST_FILTER_FLAGS)
memcheck-target-config_dnsmasq_c.elf: VALGRIND_GTEST_FILTER?=*:-*_Target*.*:*.*_Target*
memcheck-target-config_dnsmasq_c.elf: VALGRIND_TARGET_EXECUTABLE=config_dnsmasq_c.elf
memcheck-target-config_dnsmasq_c.elf: VG_TOOL=memcheck
memcheck-target-config_dnsmasq_c.elf: $(BIN_DIR)/config_dnsmasq_c.elf $(VALGRIND)
memcheck-target-config_dnsmasq_c.elf: VALGRIND_ARGS=$(VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL) $(VG_ABS_DUT) $(VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL)
memcheck-target-config_dnsmasq_c.elf:
	$(call vg-version)
	$(call vg-caller)
...
helgrind-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL = $(VALGRIND_FLAGS)        $(config_dnsmasq_c.elf_VALGRIND_FLAGS)        $(HELGRIND_FLAGS)        $(config_dnsmasq_c.elf_HELGRIND_FLAGS) $(call valgrind_xml_flags,config_dnsmasq_c.elf,HELGRIND)
helgrind-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL = $(VALGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_VALGRIND_TARGET_FLAGS) $(HELGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_HELGRIND_TARGET_FLAGS) $(VALGRIND_GTEST_FILTER_FLAGS)
helgrind-target-config_dnsmasq_c.elf: VALGRIND_GTEST_FILTER?=*:-*_Target*.*:*.*_Target*
helgrind-target-config_dnsmasq_c.elf: VALGRIND_TARGET_EXECUTABLE=config_dnsmasq_c.elf
helgrind-target-config_dnsmasq_c.elf: VG_TOOL=helgrind
helgrind-target-config_dnsmasq_c.elf: $(BIN_DIR)/config_dnsmasq_c.elf $(VALGRIND)
helgrind-target-config_dnsmasq_c.elf: VALGRIND_ARGS=$(VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL) $(VG_ABS_DUT) $(VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL)
helgrind-target-config_dnsmasq_c.elf:
	$(call vg-version)
	$(call vg-caller)
...
callgrind-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL = $(VALGRIND_FLAGS)        $(config_dnsmasq_c.elf_VALGRIND_FLAGS)        $(CALLGRIND_FLAGS)        $(config_dnsmasq_c.elf_CALLGRIND_FLAGS) $(call valgrind_xml_flags,config_dnsmasq_c.elf,CALLGRIND)
callgrind-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL = $(VALGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_VALGRIND_TARGET_FLAGS) $(CALLGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_CALLGRIND_TARGET_FLAGS) $(VALGRIND_GTEST_FILTER_FLAGS)
callgrind-target-config_dnsmasq_c.elf: VALGRIND_GTEST_FILTER?=*:-*_Target*.*:*.*_Target*
callgrind-target-config_dnsmasq_c.elf: VALGRIND_TARGET_EXECUTABLE=config_dnsmasq_c.elf
callgrind-target-config_dnsmasq_c.elf: VG_TOOL=callgrind
callgrind-target-config_dnsmasq_c.elf: $(BIN_DIR)/config_dnsmasq_c.elf $(VALGRIND)
callgrind-target-config_dnsmasq_c.elf: VALGRIND_ARGS=$(VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL) $(VG_ABS_DUT) $(VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL)
callgrind-target-config_dnsmasq_c.elf:
	$(call vg-version)
	$(call vg-caller)
...
cachegrind-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL = $(VALGRIND_FLAGS)        $(config_dnsmasq_c.elf_VALGRIND_FLAGS)        $(CACHEGRIND_FLAGS)        $(config_dnsmasq_c.elf_CACHEGRIND_FLAGS) $(call valgrind_xml_flags,config_dnsmasq_c.elf,CACHEGRIND)
cachegrind-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL = $(VALGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_VALGRIND_TARGET_FLAGS) $(CACHEGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_CACHEGRIND_TARGET_FLAGS) $(VALGRIND_GTEST_FILTER_FLAGS)
cachegrind-target-config_dnsmasq_c.elf: VALGRIND_GTEST_FILTER?=*:-*_Target*.*:*.*_Target*
cachegrind-target-config_dnsmasq_c.elf: VALGRIND_TARGET_EXECUTABLE=config_dnsmasq_c.elf
cachegrind-target-config_dnsmasq_c.elf: VG_TOOL=cachegrind
cachegrind-target-config_dnsmasq_c.elf: $(BIN_DIR)/config_dnsmasq_c.elf $(VALGRIND)
cachegrind-target-config_dnsmasq_c.elf: VALGRIND_ARGS=$(VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL) $(VG_ABS_DUT) $(VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL)
cachegrind-target-config_dnsmasq_c.elf:
	$(call vg-version)
	$(call vg-caller)
...
massif-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL = $(VALGRIND_FLAGS)        $(config_dnsmasq_c.elf_VALGRIND_FLAGS)        $(MASSIF_FLAGS)        $(config_dnsmasq_c.elf_MASSIF_FLAGS) $(call valgrind_xml_flags,config_dnsmasq_c.elf,MASSIF)
massif-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL = $(VALGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_VALGRIND_TARGET_FLAGS) $(MASSIF_TARGET_FLAGS) $(config_dnsmasq_c.elf_MASSIF_TARGET_FLAGS) $(VALGRIND_GTEST_FILTER_FLAGS)
massif-target-config_dnsmasq_c.elf: VALGRIND_GTEST_FILTER?=*:-*_Target*.*:*.*_Target*
massif-target-config_dnsmasq_c.elf: VALGRIND_TARGET_EXECUTABLE=config_dnsmasq_c.elf
massif-target-config_dnsmasq_c.elf: VG_TOOL=massif
massif-target-config_dnsmasq_c.elf: $(BIN_DIR)/config_dnsmasq_c.elf $(VALGRIND)
massif-target-config_dnsmasq_c.elf: VALGRIND_ARGS=$(VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL) $(VG_ABS_DUT) $(VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL)
massif-target-config_dnsmasq_c.elf:
	$(call vg-version)
	$(call vg-caller)
...
drd-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL = $(VALGRIND_FLAGS)        $(config_dnsmasq_c.elf_VALGRIND_FLAGS)        $(DRD_FLAGS)        $(config_dnsmasq_c.elf_DRD_FLAGS) $(call valgrind_xml_flags,config_dnsmasq_c.elf,DRD)
drd-target-config_dnsmasq_c.elf: VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL = $(VALGRIND_TARGET_FLAGS) $(config_dnsmasq_c.elf_VALGRIND_TARGET_FLAGS) $(DRD_TARGET_FLAGS) $(config_dnsmasq_c.elf_DRD_TARGET_FLAGS) $(VALGRIND_GTEST_FILTER_FLAGS)
drd-target-config_dnsmasq_c.elf: VALGRIND_GTEST_FILTER?=*:-*_Target*.*:*.*_Target*
drd-target-config_dnsmasq_c.elf: VALGRIND_TARGET_EXECUTABLE=config_dnsmasq_c.elf
drd-target-config_dnsmasq_c.elf: VG_TOOL=drd
drd-target-config_dnsmasq_c.elf: $(BIN_DIR)/config_dnsmasq_c.elf $(VALGRIND)
drd-target-config_dnsmasq_c.elf: VALGRIND_ARGS=$(VALGRIND_BUILDTARGET_TOOL_FLAGS_CALL) $(VG_ABS_DUT) $(VALGRIND_BUILDTARGET_TOOL_TARGET_FLAGS_CALL)
drd-target-config_dnsmasq_c.elf:
	$(call vg-version)
	$(call vg-caller)
