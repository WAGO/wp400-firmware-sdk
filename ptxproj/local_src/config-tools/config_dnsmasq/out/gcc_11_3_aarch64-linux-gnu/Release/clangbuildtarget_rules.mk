...
$(DEPS_config_dnsmasq_c.elf) $(OBJS_config_dnsmasq_c.elf) $(LOBS_config_dnsmasq_c.elf) $(TIDYS_config_dnsmasq_c.elf) $(PLINTS_config_dnsmasq_c.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/config_dnsmasq_c.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(config_dnsmasq_c.elf_CPPFLAGS)

$(DEPS_config_dnsmasq_c.elf) $(OBJS_config_dnsmasq_c.elf) $(TIDYS_config_dnsmasq_c.elf) $(PLINTS_config_dnsmasq_c.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/config_dnsmasq_c.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(config_dnsmasq_c.elf_CXXFLAGS)

$(DEPS_config_dnsmasq_c.elf) $(OBJS_config_dnsmasq_c.elf) $(TIDYS_config_dnsmasq_c.elf) $(PLINTS_config_dnsmasq_c.elf) ./out/gcc_11_3_aarch64-linux-gnu/Release/config_dnsmasq_c.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(config_dnsmasq_c.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/config_dnsmasq_c.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,config_dnsmasq_c.elf,$<) > $@
...
$(OUT_DIR)/config_dnsmasq_c.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(config_dnsmasq_c.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/config_dnsmasq_c.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/config_dnsmasq_c.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(config_dnsmasq_c.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/config_dnsmasq_c.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_libconfig_dnsmasq.a) $(OBJS_libconfig_dnsmasq.a) $(LOBS_libconfig_dnsmasq.a) $(TIDYS_libconfig_dnsmasq.a) $(PLINTS_libconfig_dnsmasq.a) ./out/gcc_11_3_aarch64-linux-gnu/Release/libconfig_dnsmasq.a/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libconfig_dnsmasq.a_CPPFLAGS)

$(DEPS_libconfig_dnsmasq.a) $(OBJS_libconfig_dnsmasq.a) $(TIDYS_libconfig_dnsmasq.a) $(PLINTS_libconfig_dnsmasq.a) ./out/gcc_11_3_aarch64-linux-gnu/Release/libconfig_dnsmasq.a/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libconfig_dnsmasq.a_CXXFLAGS)

$(DEPS_libconfig_dnsmasq.a) $(OBJS_libconfig_dnsmasq.a) $(TIDYS_libconfig_dnsmasq.a) $(PLINTS_libconfig_dnsmasq.a) ./out/gcc_11_3_aarch64-linux-gnu/Release/libconfig_dnsmasq.a/lint_mac.h: BUILDTARGET_CFLAGS:=$(libconfig_dnsmasq.a_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Release/info/libconfig_dnsmasq.a-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libconfig_dnsmasq.a,$<) > $@
...
$(OUT_DIR)/libconfig_dnsmasq.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libconfig_dnsmasq.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/libconfig_dnsmasq.a/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libconfig_dnsmasq.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libconfig_dnsmasq.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Release/libconfig_dnsmasq.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
