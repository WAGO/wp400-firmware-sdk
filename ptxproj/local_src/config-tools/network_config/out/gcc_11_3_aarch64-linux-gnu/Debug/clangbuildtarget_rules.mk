...
$(DEPS_network_config.elf) $(OBJS_network_config.elf) $(LOBS_network_config.elf) $(TIDYS_network_config.elf) $(PLINTS_network_config.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/network_config.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(network_config.elf_CPPFLAGS)

$(DEPS_network_config.elf) $(OBJS_network_config.elf) $(TIDYS_network_config.elf) $(PLINTS_network_config.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/network_config.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(network_config.elf_CXXFLAGS)

$(DEPS_network_config.elf) $(OBJS_network_config.elf) $(TIDYS_network_config.elf) $(PLINTS_network_config.elf) ./out/gcc_11_3_aarch64-linux-gnu/Debug/network_config.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(network_config.elf_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug/info/network_config.elf-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,network_config.elf,$<) > $@
...
$(OUT_DIR)/network_config.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(network_config.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/network_config.elf/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/network_config.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(network_config.elf_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/network_config.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_libnetwork_config.a) $(OBJS_libnetwork_config.a) $(LOBS_libnetwork_config.a) $(TIDYS_libnetwork_config.a) $(PLINTS_libnetwork_config.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libnetwork_config.a/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libnetwork_config.a_CPPFLAGS)

$(DEPS_libnetwork_config.a) $(OBJS_libnetwork_config.a) $(TIDYS_libnetwork_config.a) $(PLINTS_libnetwork_config.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libnetwork_config.a/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libnetwork_config.a_CXXFLAGS)

$(DEPS_libnetwork_config.a) $(OBJS_libnetwork_config.a) $(TIDYS_libnetwork_config.a) $(PLINTS_libnetwork_config.a) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libnetwork_config.a/lint_mac.h: BUILDTARGET_CFLAGS:=$(libnetwork_config.a_CFLAGS)
...
./out/gcc_11_3_aarch64-linux-gnu/Debug/info/libnetwork_config.a-info.txt: $(SCRIPT_DIR)/internal/clang/info_txt.template $(MK_FILES); $(SILENT)$(call clangbuild_subst_info_buildtarget,libnetwork_config.a,$<) > $@
...
$(OUT_DIR)/libnetwork_config.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libnetwork_config.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libnetwork_config.a/%.o.d $(wildcard .clang-tidy) | $(TIDY_SUPPORT_DIRS); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libnetwork_config.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(libnetwork_config.a_PRECLANG_FILES) ./out/gcc_11_3_aarch64-linux-gnu/Debug/libnetwork_config.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
