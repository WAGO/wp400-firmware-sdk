...
ifdef PTXCONF_GCCLIBS_GCC_S
	@$(call install_copy_toolchain_lib, gcclibs, libgcc_s.so, /usr/lib)
endif
...
ifdef PTXCONF_GCCLIBS_ATOMIC
	@$(call install_copy_toolchain_lib, gcclibs, libatomic.so, /usr/lib)
endif
...
ifdef PTXCONF_GCCLIBS_LIBASAN
	@$(call install_copy_toolchain_lib, gcclibs, libasan.so, /usr/lib)
endif

ifdef PTXCONF_GCCLIBS_LIBLSAN
	@$(call install_copy_toolchain_lib, gcclibs, liblsan.so, /usr/lib)
endif

ifdef PTXCONF_GCCLIBS_LIBTSAN
	@$(call install_copy_toolchain_lib, gcclibs, libtsan.so, /usr/lib)
endif

ifdef PTXCONF_GCCLIBS_LIBUBSAN
	@$(call install_copy_toolchain_lib, gcclibs, libubsan.so, /usr/lib)
endif
